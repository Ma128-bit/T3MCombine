...
if __name__ == "__main__":
    ...
    if args.version==2:
           ...
           command +=" combineCards.py CMS_T3MSignal_13TeV_A1.txt CMS_T3MSignal_13TeV_A2.txt CMS_T3MSignal_13TeV_A3.txt> CMS_T3MSignal_13TeV_Combined_A.txt;"
           command +=" combineCards.py CMS_T3MSignal_13TeV_B1.txt CMS_T3MSignal_13TeV_B2.txt CMS_T3MSignal_13TeV_B3.txt> CMS_T3MSignal_13TeV_Combined_B.txt;"
           command +=" combineCards.py CMS_T3MSignal_13TeV_C1.txt CMS_T3MSignal_13TeV_C2.txt CMS_T3MSignal_13TeV_C3.txt> CMS_T3MSignal_13TeV_Combined_C.txt;"
    else:
